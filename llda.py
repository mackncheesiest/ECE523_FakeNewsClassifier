...
# Taken from https://github.com/shuyo/iir/blob/master/lda/llda.py

# For our purposes, this is just the class that we're using and trying to sort of understand how it works
