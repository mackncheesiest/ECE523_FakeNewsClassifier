...
# Taken from https://github.com/shuyo/iir/blob/master/lda/llda_nltk.py

# For our purposes, this is just an example of using the llda class to sort of see what it does
# It requires installing the nltk library (conda install nltk)
# And then calling nltk.download() which opens up a GUI and allows you to download the reuters dataset
# THEN, it should probably work just by running it like a script.
...
parser.add_option("-n", dest="samplesize", type="int", help="dataset sample size", default=10)
